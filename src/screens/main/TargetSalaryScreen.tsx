...
import { getCurrencySymbol, getCountryByCode } from '../../data';
...
export function TargetSalaryScreen() {
  ...
  const percentIncrease =
    results.netMonthly > 0 ? ((diffMonthly / results.netMonthly) * 100) : 0;
              ...
              <View style={styles.statRow}>
                <View style={styles.statItem}>
                  ...
                  <Text
                    style={[
                      styles.statValue,
                      { color: diffMonthly >= 0 ? theme.success : theme.danger },
                    ]}
                  >
                    {diffMonthly >= 0 ? '+' : ''}
                ...
                <View style={styles.statItem}>
                  ...
                  <Text
                    style={[
                      styles.statValue,
                      { color: percentIncrease >= 0 ? theme.success : theme.danger },
                    ]}
                  >
                    {percentIncrease >= 0 ? '+' : ''}
              ...
              <View style={[styles.statRow, { marginTop: 16 }]}>
                <View style={styles.statItem}>
                  ...
                  <Text
                    style={[
                      styles.statValue,
                      { color: diffYearly >= 0 ? theme.success : theme.danger },
                    ]}
                  >
                    {diffYearly >= 0 ? '+' : ''}
